...
- Crea un vector de tipo  FloatArray de 10 elements, carregar els seus elements per teclat
  imprimir la cantitat de valors introduits que siguin menors de 50. Imprimir un  missatge si tots els valors son menors de 50. [ [Solucio](https://github.com/marcmoiagese/curskotlin/blob/master/37-Expresions_lambda_amb_vecors_IntArray_FloatArray_DoubleArray_etc/Problema1/src/main/kotlin/Main.kt) ]
